...
def list_available_backups():
    ...
    backups = []
    try:
        # Asegurarnos de buscar de forma segura en el directorio seleccionado
...
def get_execution_logs():
    ...
    # Normalizar claves para que el JS las lea sin errores (tipo, objetivo, estado, duracion)
    formatted_logs = []
    for l in logs:
...
async def websocket_progress_endpoint(websocket: WebSocket):
    ...
    try:
        ...
        ws_manager.disconnect(websocket)onfig_manager.config.selected_target_disk
